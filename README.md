...
```bash
./mvnw clean verify                       # 262 tests: 253 run, 9 skipped, 0 failures
...
| Run | 278 | 0 failures (13 + 36 + 63 + 10 + 85 + 11 + 19 + 24 + 9 + 8) |
