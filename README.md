...
| The console | Built and tested in CI on every push or pull request to `main`: lint, types, 69 unit tests, the production build, and 22 Playwright tests in Chromium against the service's own jar, two of them at eleven viewports. Never hosted. |
