...
| The console | Built and tested in CI on every push or pull request to `main`: lint, types, 54 unit tests, the production build, and 20 Playwright tests in Chromium against the service's own jar. Never hosted. |
