...
| The console | Built and tested in CI on every push or pull request to `main`: lint, types, 103 unit tests, the production build, and 23 Playwright tests in Chromium against the service's own jar, three of them at eleven viewports. Never hosted. |
